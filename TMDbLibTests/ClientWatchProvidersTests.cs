...
public class ClientWatchProvidersTests : TestBase
{
    ...
    {
        var watchProviderRegions = await TMDbClient.GetWatchProviderRegionsAsync(TestContext.Current.CancellationToken);
    ...
    {
        var watchProviders = await TMDbClient.GetMovieWatchProvidersAsync(TestContext.Current.CancellationToken);
    ...
    {
        var watchProviders = await TMDbClient.GetTvWatchProvidersAsync(TestContext.Current.CancellationToken);
