...
public class ClientConfigurationTests : TestBase
{
    ...
    {
        var result = await TMDbClient.GetPrimaryTranslationsAsync(TestContext.Current.CancellationToken);
        Assert.NotNull(result);
    ...
    {
        var result = await TMDbClient.GetCountriesAsync(TestContext.Current.CancellationToken);
        Assert.NotNull(result);
    ...
    {
        var result = await TMDbClient.GetLanguagesAsync(TestContext.Current.CancellationToken);
        Assert.NotNull(result);
        Assert.NotEmpty(result);
    ...
    {
        var result = await TMDbClient.GetTimezonesAsync(TestContext.Current.CancellationToken);
        Assert.NotNull(result);
    ...
    {
        var jobs = await TMDbClient.GetJobsAsync(TestContext.Current.CancellationToken);
        Assert.NotNull(jobs);
