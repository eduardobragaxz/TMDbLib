...
public class ClientGenreTests : TestBase
{
    ...
    {
        // Default language
        var genres = await TMDbClient.GetTvGenresAsync(TestContext.Current.CancellationToken);

        // Another language
        var genresDanish = await TMDbClient.GetTvGenresAsync("da", TestContext.Current.CancellationToken);
    ...
    {
        // Default language
        var genres = await TMDbClient.GetMovieGenresAsync(TestContext.Current.CancellationToken);

        // Another language
        var genresDanish = await TMDbClient.GetMovieGenresAsync("da", TestContext.Current.CancellationToken);
