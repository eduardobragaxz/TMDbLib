...
public class ClientNetworkTests : TestBase
{
    ...
    {
        var network = await TMDbClient.GetNetworkAsync(IdHelper.Netflix, TestContext.Current.CancellationToken);
    ...
    {
        var logos = await TMDbClient.GetNetworkImagesAsync(IdHelper.Netflix, TestContext.Current.CancellationToken);
    ...
    {
        var names = await TMDbClient.GetNetworkAlternativeNamesAsync(IdHelper.AMC, TestContext.Current.CancellationToken);
    ...
    {
        var network = await TMDbClient.GetNetworkAsync(IdHelper.MissingID, TestContext.Current.CancellationToken);
