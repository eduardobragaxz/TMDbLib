...
public class CombinedCreditsConverterTest : TestBase
{
    ...
    public async Task TestJsonCombinedCreditsConverter()
    {
        ...
        var result = await TMDbClient.GetPersonCombinedCreditsAsync(IdHelper.BruceWillis, TestContext.Current.CancellationToken);
    ...
    public async Task TestPersonCombinedCreditsAppendToResponse()
    {
        ...
        var person = await TMDbClient.GetPersonAsync(IdHelper.BruceWillis, PersonMethods.CombinedCredits, TestContext.Current.CancellationToken);
